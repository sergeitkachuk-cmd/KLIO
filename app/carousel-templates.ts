...
export const CAROUSEL_TEMPLATE_OPTIONS: readonly CarouselTemplateOption[] = [
  {
    ...
    instruction: "Премиальная редакционная система: глубокий тёмный фон, светлая типографика, мягкие градиентные акценты, аккуратная сетка, много воздуха и один ясный визуальный фокус.",
  },
  {
    value: "gradient-pop",
