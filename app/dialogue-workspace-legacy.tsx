...
import type { SharedGeneration, DialogueWorkspaceProps } from "./dialogue-workspace-types";
export type { DialogueWorkspaceProps } from "./dialogue-workspace-types";
type ApiResult = {
...
export function LegacyDialogueWorkspace(props: DialogueWorkspaceProps) {
